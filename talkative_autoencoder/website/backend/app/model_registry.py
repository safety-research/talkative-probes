...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    "qwen2.5-14b-wildchat": ModelConfig(
        ...
        description="Qwen 2.5 14B prepared on FineWeb, then furthertrained on WildChat dataset",
    ...
    "gemma2-9b-wildchat": ModelConfig(
        ...
        description="Gemma 2 9B trained only WildChat dataset",
    ...
    "gemma3-27b-chat": ModelConfig(
        ...
        description="Gemma 3 27B trained on FineWeb, then further trained on chat data",
