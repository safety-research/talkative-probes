...
check_activations() {
    ...
    local activation_dirs=(
        "./data/${model_name_clean}/layer_${layer}/${dataset}"  # New clean format
        "./data/${model_name}/layer_${layer}/${dataset}"        # Existing format with slashes
        "./data/${dataset}"                                      # Direct dataset path
    )
