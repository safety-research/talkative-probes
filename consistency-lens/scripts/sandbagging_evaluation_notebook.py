...
CHECKPOINT_PATH_CHATTUNED_BASECHAT = "/workspace/kitf/talkative-probes/consistency-lens/outputs/checkpoints/gemma2_CHAT_9b_frozen_nopostfix_SUS_gemma-2-9b-it_L30_e30_frozen_lr1e-4_t8_2ep_resume_0714_170910_ITBASE_NO_ENC_PROJ_OTF_dist8_slurm6054"
...
# Run analysis
representation_resultschattuned = analyze_transcript_representations(analyzerchattuned_basechat, example_response, "gemma-2-9b-it-chattuned-basechat")
# %%
